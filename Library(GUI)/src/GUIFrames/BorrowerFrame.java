...
PreparedStatement stmt;
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(ReturnBook, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(44, 44, 44))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(21, 21, 21)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void borrowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrowActionPerformed
       ...
       int[] indexs = BookTable2.getSelectedRows();
       int account = Integer.parseInt(AccountId.getText());
       Object [] row = new Object[4];
       DefaultTableModel def = (DefaultTableModel)Table3.getModel();
       for(int i = 0;i<indexs.length;i++){
           row[0] = table.getValueAt(indexs[i], 1);
           row[1] = table.getValueAt(indexs[i], 2);
           def.addRow(row);
       }
